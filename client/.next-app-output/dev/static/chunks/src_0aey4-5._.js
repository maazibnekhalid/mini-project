...
function SignupPage() {
    ...
    const handleSubmit = async (event)=>{
        ...
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signup"])({
                name,
                email,
                password
            });
            ...
            const message = err instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["AxiosError"] ? err.response?.data?.message || "Unable to sign up." : "Unable to sign up.";
            setError(message);
        } finally{
...
_s(SignupPage, "2oC9k3lbnMANyeKCU8mr5Sybi7Y=", false, function() {
    return [
...
//# sourceMappingURL=src_0aey4-5._.js.map